...
// TEMP-DIAGNOSE (entfernen, sobald der Prod-500 geklaert ist):
// Wenn dieser GET auf /api/posts/add eine JSON-Antwort liefert, hat das
// Modul samt aller top-level Imports sauber initialisiert -> der Crash lag
// in der POST-Laufzeit. Liefert der GET selbst einen leeren Plattform-500,
// crasht das Modul beim Laden (ein Import wirft beim Init).
export async function GET() {
  return new Response(
    JSON.stringify({ probe: 'add-route-loaded', ok: true }),
