...
import { loadProgress, totalScore } from '../lib/archaea-lipids-progress.js';

// Kleine Karte fuer mikrobiologie.astro: Link aufs Minigame + Fortschritts-
// leiste aus localStorage. Hydratisiert client-seitig, weil der Score per
// User im Browser liegt.
export default function ArchaeaLipidsMikrobioCard() {
  const [score, setScore] = useState(null);

  useEffect(() => {
    setScore(totalScore(loadProgress()));
    // Bei Tab-Wechsel von Game zurueck zu mikrobio-Seite: nichts zu tun, weil
    // der User navigiert (volle Seitenladung). Wenn das mal SPA wird, hier
    // Storage-Event hooken.
  }, []);
